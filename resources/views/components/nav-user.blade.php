                ...
                <ul class="py-2" aria-labelledby="user-menu-button">
                    <li>
                        <a href="{{ route('logout-user') }}"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Logout User</a>
                    </li>
                </ul>
            </div>
        @else
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow"
                ...
                <ul class="py-2" aria-labelledby="user-menu-button">
                    <li>
                        <a href="/login-user" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Login
                            User</a>
                    </li>
                    <li>
