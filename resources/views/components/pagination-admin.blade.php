        ...
        <ul class="flex items-center space-x-2 h-8 text-sm">
            ...
            @for ($i = $min; $i <= $max; $i++)
                @if ($i == $current)
                    <li>
                        <a href="?page={{ $i }}"
                            class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border bg-gray-700 hover:text-gray-700 dark:border-gray-700 dark:text-white dark:bg-gray-700 dark:hover:text-white">{{ $i }}</a>
                    </li>
                @else
                    <li>
                        <a href="?page={{ $i }}"
