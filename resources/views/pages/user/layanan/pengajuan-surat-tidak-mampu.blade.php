...
<body>
    ...
    <div>
        ...
        <section id="cover"
            ...
            <form action="{{route('pengajuan-surat-tidak-mampu.post')}}" method="POST" enctype="multipart/form-data" class="relative full m-5 lg:m-10 p-6 z-10 text-black">
                @csrf
                            ...
                            <div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <select id="jenis-kelamin-orang-tua"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" name="jenis_kelamin_orang_tua"
                                        required>
                                ...
                                <div class="mb-2">
                                    ...
                                    <select id="jeniskelamindiri"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" name="jenis_kelamin"
                                        required>
                                        <option value="" selected disabled>Pilih Jenis Kelamin</option>
                                        <option value="Pria">Pria</option>
                                        <option value="Wanita">Wanita</option>
                                ...
                                <div class="mb-2 relative">
                                    ...
                                    <input type="name" id="keperluan" placeholder="Alamat" name="keperluan"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                        required />
                                </div>
                            </div>
