...
<body>
    ...
    <div>
        ...
        <section id="cover"
            ...
            <form action="{{route('pengajuan-surat-pengantar-skck.post')}}" method="POST" enctype="multipart/form-data" class="relative full m-5 lg:m-10 p-6 z-10 text-black">
                @csrf
                            ...
                            <div>
                                ...
                                <div class="mb-2">
                                    <label for="status-perkawinan-diri"
                                        ...
                                        Perkawinan</label>
                                    <select id="status-perkawinan-diri" name="status_perkawinan"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                        required>
