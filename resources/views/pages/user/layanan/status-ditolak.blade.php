    ...
    <div>
        ...
        <section id="cover" class="relative bg-center bg-no-repeat bg-cover bg-white bg-blend-multiply min-h-screen flex items-center justify-center">
            <form class="relative w-full m-5 lg:m-10 p-6 z-10 text-black">
                <div class="font-bold text-2xl lg:text-4xl mb-5 lg:mb-10 mt-10 lg:mt-0 text-[#2B2A4C] underline underline-offset-4">
                    Status Permohonan
                </div>
                <div class="mt-10 mb-10 text-4xl text-center text-[#D72323] font-bold">DOKUMEN ANDA DITOLAK</div>
                <div class="m-10 lg:m-20 justify-center item-center bg-[#2B2A4C]">
                    <div class="">Alasan : </div>
                    <ul class="list-disc list-inside ml-4">
                        <li>Foto KTP Blur</li>
                        <li>Nama Tidak Sesuai</li>
                    </ul>
                    <a href="/layanan-status-permohonan" class="mt-10 btn border-none w-full lg:w-[50%] flex justify-center items-center m-auto text-white bg-[#2B2A4C] hover:bg-[#191831] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
