            ...
            <div class="">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="pb-4">
                        ...
                        <input type="email" id="email" name="email" class="bg-white mt-1 block w-full px-3 py-1 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="admin@gmail.com" required>
                    </div>
                    <div class="pb-4 relative">
                        <label for="password" class="block text-sm font-medium text-gray-700">Kata Sandi</label>
                        <input type="password" id="password" name="password" class="bg-white mt-1 block w-full px-3 py-1 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="***********" required>
                    ...
                    <div class="flex items-center justify-center pt-6">
                        <button type="submit" class="bg-[#2B2A4C] text-white px-6 py-1 rounded-md hover:bg-gray-400">Login</button>
                    </div>
                </form>
            </div>
        </div>
