...
<head>
    ...
    <title>Surat Keterangan Pengantar SKCK</title>
...
<body>
    ...
    <div class="pb-20 pl-4 pr-4 sm:ml-64">
        ...
        <h2 class="text-normal font-light pb-4">Surat Keterangan Pengantar SKCK</h2>
            ...
            <div class="">
                ...
                @if ($datas->status != 'Ditolak')
                    <div class="flex justify-between mt-6 mx-auto w-[100%] pb-4">
                        <x-pop-up-tolak />
                        <form action="{{ route('verif.skpskck', $datas->id) }}" method="POST">
                            @csrf
                            <button type="submit"
...
<script>
    document.getElementById('submit-reject').addEventListener('click', function() {
        ...
        form.method = 'POST';
        form.action =
            '{{ route('reject.skpskck', $datas->id) }}'; // Pastikan route ini sudah ada di routes/web.php
