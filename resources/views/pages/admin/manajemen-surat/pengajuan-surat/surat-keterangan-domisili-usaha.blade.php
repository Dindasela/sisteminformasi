            ...
            <div class="flex mx-auto w-[70%] grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-16">
                <div class="spaye-y-4">
                    ...
                    <div class="pb-2">
                        ...
                        <input type="email" id="email" name="" value="{{ $datas->nama_lengkap }}"
                    ...
                    <div class="pb-2">
                        <label for="text" class="block text-sm font-normal text-gray-700">NIK
                            <input type="text" id="text" name="" value="{{ $datas->nik }}"
                                class="bg-white mt-1 block w-full px-3 py-1 border border-gray-600 rounded shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                placeholder="">
                    </div>
                    <div class="pb-2">
                    ...
                    <div class="pb-2">
                        ...
                        <select id="countries"
                            class="bg-white mt-1 block w-full px-3 py-1 border border-gray-600 rounded shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <option {{ $datas->status_perkawinan == 'Belum Kawin' ? 'selected' : '' }}>Belum Kawin
                            </option>
                    ...
                    <div class="pb-2">
                        ...
                        <input type="text" id="alamat" name="" value="{{ $datas->alamat_kk }}"
                            class="bg-white mt-1 block w-full px-3 py-1 border border-gray-600 rounded shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            placeholder="">
                    </div>
                    ...
                    <div class="pb-2">
                        ...
                        <input type="email" id="email" name="" value="{{ $datas->nama_lembaga }}"
                            class="bg-white mt-1 block w-full px-3 py-1 border border-gray-600 rounded shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            placeholder="">
                    </div>
                    <div class="pb-2">
                        <label for="text" class="block text-sm font-normal text-gray-700">NPSN
                            <input type="text" id="text" name="" value="{{ $datas->npsn }}"
                                class="bg-white mt-1 block w-full px-3 py-1 border border-gray-600 rounded shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                placeholder="">
                    </div>
                    <div class="pb-2">
                        <label for="text" class="block text-sm font-normal text-gray-700">Tahun Berdiri
                            <input type="text" id="text" name="" value="{{ $datas->tahun_berdiri }}"
                                class="bg-white mt-1 block w-full px-3 py-1 border border-gray-600 rounded shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                placeholder="">
                    </div>
                    <div class="pb-2">
                ...
                <div class="">
                    ...
                    <div class="pb-4">
                        ...
                        <div class="w-full h-36 mt-2">
                            <img class="mx-auto h-full object-cover"
                                src="{{ asset('storage/' . $datas->foto_kk) }}" />
                        </div>
                    </div>
                    <div class="pb-4">
                    ...
                    @if ($datas->status != 'Ditolak')
                        <div class="flex justify-between mt-6 mx-auto w-[100%] pb-4">
                            <x-pop-up-tolak />
                            <form action="{{ route('verif.skdu', $datas->id) }}" method="POST">
                                @csrf
                                <button type="submit"
...
<script>
    document.getElementById('submit-reject').addEventListener('click', function() {
        ...
        form.method = 'POST';
        form.action = '{{ route('reject.skdu', $datas->id) }}';
