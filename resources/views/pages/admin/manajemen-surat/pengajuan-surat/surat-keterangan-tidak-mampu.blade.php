...
<body>
    ...
    <div class="pb-20 pl-4 pr-4 sm:ml-64">
        ...
        <h2 class="text-normal font-light pb-4">Surat Keterangan Tidak Mampu</h2>
        <div class="flex mx-auto w-[70%] grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-16">
            <div class="spaye-y-4">
                ...
                <div class="pb-2">
                    ...
                    <select id="countries"
                        class="bg-white mt-1 block w-full px-3 py-1 border border-gray-600 rounded shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        <option {{ $datas->jenis_kelamin_orang_tua == 'Wanita' ? 'selected' : '' }}>Perempuan
                        </option>
                        <option {{ $datas->jenis_kelamin_orang_tua == 'Pria' ? 'selected' : '' }}>Laki-Laki
                        </option>
                    </select>
                </div>
                <div class="pb-2">
                ...
                <div class="pb-2">
                    ...
                    <select id="countries"
                        ...
                        <option {{ $datas->agama_orang_tua == 'Kristen Protestan' ? 'selected' : '' }}>Kristen
                        </option>
            ...
            <div class="">
                ...
                @if ($datas->status != 'Ditolak')
                    <div class="flex justify-between mt-6 mx-auto w-[100%] pb-4">
                        <x-pop-up-tolak />
                        <form action="{{ route('verif.sktm', $datas->id) }}" method="POST">
                            @csrf
                            <button type="submit"
...
<script>
    document.getElementById('submit-reject').addEventListener('click', function() {
        ...
        form.method = 'POST';
        form.action =
        '{{ route('reject.sktm', $datas->id) }}'; // Pastikan route ini sudah ada di routes/web.php
