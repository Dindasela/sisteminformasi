        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-2 pb-16">
            <div class="flex items-center   ">
                <div class="w-full h-96 ">
                    ...
                    @if ($data->file) 
                        <img class="mx-auto h-full object-cover" src="{{asset('storage/' . $data->file)}}" />
                    @else
            ...
            <div class="overflow-x-auto ">
                ...
                <div class="bg-[#F5F3F3] pb-20 p-6 rounded-lg shadow-lg">
                    <h2 class="text-xl font-semibold mb-4 text-center">Arsip Surat Masuk</h2>
                        ...
                        <div class="space-y-2">
                            <div class="flex gap-24">
                                <label for="jenisSurat"
                                    ...
                                    Surat</label>
                                <input type="text" id="jenisSurat" name="jenisSurat"
                                    ...
                                    placeholder="" value="{{ $data->jenis_surat }}">
                            </div>
                            <div class="flex gap-24">
                                <label for="pengirim"
                                    class="flex items-center block text-sm font-medium text-gray-700 w-52">Pengirim</label>
                                <input type="text" id="pengirim" name="pengirim"
                                    class="bg-[#F5F3F3] mt-1 block w-full px-3 py-2 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    placeholder="" value="{{ $data->pengirim }}">
                            </div>
                            <div class="flex gap-24">
                                ...
                                <input type="text" id="nomorSurat" name="nomorSurat"
                                    class="bg-[#F5F3F3] mt-1 block w-full px-3 py-2 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    placeholder="" value="{{ $data->nomor_surat }}">
                            </div>
                            <div class="flex gap-24">
                                <label for="perihal"
                                    class="flex items-center block text-sm font-medium text-gray-700 w-52">Perihal</label>
                                <input type="text" id="perihal" name="perihal"
                                    class="bg-[#F5F3F3] mt-1 block w-full px-3 py-2 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    placeholder="" value="{{ $data->perihal }}">
                            </div>
                            <div class="flex gap-24">
                                @php
                                    $ts = Carbon\Carbon::parse($data->tanggal_surat);
                                @endphp
                                <label for="tanggalSurat"
                                    class="flex items-center block text-sm font-medium text-gray-700 w-52">Tanggal
                                    Surat</label>
                                <input type="date" id="tanggalSurat" name="tanggalSurat"
                                    class="bg-[#F5F3F3] mt-1 block w-full px-3 py-2 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    value="{{ $ts->format('Y-m-d') }}">
                            </div>
                            <div class="flex gap-24">
                                @php
                                    $tt = Carbon\Carbon::parse($data->tanggal_terima);
                                @endphp
                                <label for="tanggalTerima"
                                    class="flex items-center block text-sm font-medium text-gray-700 w-52">Tanggal
                                    Terima</label>
                                <input type="date" id="tanggalTerima" name="tanggalTerima"
                                    class="bg-[#F5F3F3] mt-1 block w-full px-3 py-2 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    value="{{ $tt->format('Y-m-d') }}">
                            </div>
                            {{-- <div class="flex gap-24">
