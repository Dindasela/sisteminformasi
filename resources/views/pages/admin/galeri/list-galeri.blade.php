    ...
    <div class="pb-4 pl-4 pr-4 sm:ml-64">
        ...
        <div class="flex pb-2">
            ...
            <div class="absolute top-30 right-5 flex justify-between items-center rounded-md">
                <a href="/tambah-foto-video"
                    class="bg-[#2B2A4C] w-32 flex items-center p-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    @foreach ($gallery as $index => $item)
                        <tr class="border-2 bg-[#DDDBDB] ">
                            ...
                            <td class="px-6 py-4">
                                <div>
                                    <ul
                                        class="flex items-center justify-center {{ $item->status == 'Tayang' ? 'bg-[#82FA6F]' : 'bg-[#FCFF8F]' }} text-black rounded-xl w-24">
                                        <li>{{ $item->status }}</li>
                                    </ul>
                                </div>
                            </td>
                                ...
                                <div class="flex">
                                    ...
                                    <form action="{{ route('galeri.destroy', $item->id) }}" method="POST"
                                        ...
                                        <button type="submit" class="text-red-600 hover:text-red-900">
                                            <svg width="21" height="20" viewBox="0 0 21 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M3 5H18" stroke="black" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    stroke="black" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M8.83331 9.16699V14.167" stroke="black" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M12.1667 9.16699V14.167" stroke="black" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        </button>
                                    </form>
