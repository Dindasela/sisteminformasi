    ...
    <div class="pb-4 pl-4 pr-4 sm:ml-64">
        ...
        <div class="flex pb-2">
            ...
            <div class="absolute top-30 right-5 flex justify-between items-center rounded-md">
                <a href="/tambah-pengumuman"
                    class="bg-[#2B2A4C] w-56 flex items-center p-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <tr class="border-2 bg-[#DDDBDB]">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex">
                                    ...
                                    <a href="/edit-pengumuman/{{ $item->id }}" class="mr-2">
                                        <svg width="21" height="20" viewBox="0 0 21 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
